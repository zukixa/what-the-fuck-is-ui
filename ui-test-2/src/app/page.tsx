...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section 
  id="about" 
    className="w-full py-12 md:py-24 lg:py-32 xl:py-48 pb-4 md:pb-8 lg:pb-12"
  style={{
...
>
        ...
        <motion.section 
  id="projects"
    className="w-full py-12 md:py-24 lg:py-32 pt-4 md:pt-8 lg:pt-12 -mt-8 md:-mt-12 lg:-mt-16"
  style={{
    background: '#F5F5F5',
  }}
