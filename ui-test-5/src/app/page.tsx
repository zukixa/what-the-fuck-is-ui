                    ...
                    <Accordion type="single" collapsible className="w-full">
                      ...
                      <AccordionItem value="privacy-command">
                        ...
                        <AccordionContent>
                          ...
                          <ul>
                            <li>Provides information on how user data is handled</li>
                            <li>Helps users understand their rights and the bot&apos;s responsibilities</li>
                          </ul>
                        </AccordionContent>
                      </AccordionItem>
                      <AccordionItem value="settings-command">
                        ...
                        <AccordionContent>
                          <p>Usage: `/settings [Task] [Text (Optional)]`</p>
                          <p>Adjust various bot settings for your server</p>
                          <ul>
                            <li>View overall settings</li>
                            <li>Adjust /gm command difficulty</li>
                            <li>Customize @zuki.gm system prompt</li>
                            <li>Modify /gm command output format</li>
                            <li>Manage server-side context</li>
                            <li>Requires administrator permissions for most actions</li>
                          </ul>
                        </AccordionContent>
                      </AccordionItem>
                      <AccordionItem value="help-command">
                        ...
                        <AccordionContent>
                          ...
                          <ul>
                            <li>Provides an overview of all available commands</li>
                            <li>Displays bot statistics and server information</li>
                            <li>Offers links to other zuki.bots</li>
                            <li>Includes a page selection feature for detailed help on specific topics</li>
                          </ul>
                        </AccordionContent>
                      </AccordionItem>
                      <AccordionItem value="stats-command">
                        ...
                        <AccordionContent>
                          ...
                          <ul>
                            ...
                            <li>Provides insights into bot performance and popularity</li>
                          </ul>
                        </AccordionContent>
                      </AccordionItem>
                  ...
                  {selectedPage === "page1" && (
                    <Accordion type="single" collapsible className="w-full">
                      ...
                      <AccordionItem value="revise-command">
                        ...
                        <AccordionContent>
                          <p>Usage: `/revise [Message Link] [New Content]`</p>
                      ...
                      <AccordionItem value="war-command">
                        ...
                        <AccordionContent>
                          <p>Usage: `/war [Side 1] [Side 2 (Optional)] [Previous Results (Optional)]`</p>
                      ...
                      <AccordionItem value="gm-command">
                        ...
                        <AccordionContent>
                          <p>Usage: `/gm [Engine] [Task] [Post] [WIWTK] [Previous (Optional)] [Context (Optional)] [Visual Context (Optional)]`</p>
                      ...
                      <AccordionItem value="approve-command">
                        ...
                        <AccordionContent>
                          <p>Usage: `/approve [GM Output Link] [Post in Channel] [Ping User] [Revision Instructions (Optional)]`</p>
                  ...
                  {selectedPage === "page2" && (
                    <Accordion type="single" collapsible className="w-full">
                      ...
                      <AccordionItem value="sd-command">
                        ...
                        <AccordionContent>
                          <p>Usage: `/sd [Engine] [Style] [Prompt]`</p>
                      ...
                      <AccordionItem value="sd-clip-command">
                        ...
                        <AccordionContent>
                          <p>Usage: `/sd-clip [Engine] [Style] [Prompt] [Negative Prompt (Optional)]`</p>
                      ...
                      <AccordionItem value="sdx-v2-command">
                        ...
                        <AccordionContent>
                          <p>Usage: `/sdx-v2 [Engine] [Style] [Prompt] [Negative Prompt (Optional)] [Detail Boost (Optional)]`</p>
                      ...
                      <AccordionItem value="sdx-v1-command">
                        ...
                        <AccordionContent>
                          <p>Usage: `/sdx-v1 [Engine] [Style] [Prompt] [Negative Prompt (Optional)] [Detail Boost (Optional)]`</p>
                  ...
                  {selectedPage === "page3" && (
                    <Accordion type="single" collapsible className="w-full">
                      ...
                      <AccordionItem value="write-command">
                        ...
                        <AccordionContent>
                          <p>Usage: `/write [Task] [Engine] [Text] [Jailbreak] [MatchStyle (Optional)] [Context (Optional)] [PreviousResults (Optional)]`</p>
                  ...
                  {selectedPage === "page4" && (
                    <Accordion type="single" collapsible className="w-full">
                      ...
                      <AccordionItem value="calc-command">
                        ...
                        <AccordionContent>
                          <p>Usage: `/calc [CalcType] [Val1] [Val2] [Val3 (Optional)]`</p>
                      ...
                      <AccordionItem value="growth-command">
                        ...
                        <AccordionContent>
                          <p>Usage: `/growth [StartPop] [Average] [Years]`</p>
                  ...
                  {selectedPage === "page5" && (
                    <Accordion type="single" collapsible className="w-full">
                      ...
                      <AccordionItem value="npc-update-command">
                        ...
                        <AccordionContent>
                          <p>Usage: `/npc-update [Name of the NPC] [What to update] [New Data]`</p>
                          <p>Modify NPC Data</p>
                          <ul>
                      ...
                      <AccordionItem value="npc-autopost-command">
                        ...
                        <AccordionContent>
                          <p>Usage: `/npc-autopost [Name of the NPC] [Post Interval Hours] [Channel]`</p>
                      ...
                      <AccordionItem value="npc-talk-command">
                        ...
                        <AccordionContent>
                          <p>Usage: `/npc-talk [Name of the NPC] [Your Message]`</p>
                      ...
                      <AccordionItem value="npc-create-command">
                        ...
                        <AccordionContent>
                          <p>Usage: `/npc-create [Name] [Description] [Type] [Context] [Engine] [Goals]`</p>
                      ...
                      <AccordionItem value="npc-delete-command">
                        ...
                        <AccordionContent>
                          <p>Usage: `/npc-delete [Name of the NPC]`</p>
